...
const SkillCard = ({ name, description, imgUrl }: SkillCardProps) => {
  return (
    <div
      ...
      hover:scale-[1.008] hover:bg-gray-200 dark:bg-black dark:border-neutral-900 group">
      <div className="w-full flex items-center justify-center pt-8">
        <img src={imgUrl} className="h-[120px] object-cover aspect-square rounded-2xl group-hover:opacity-80 " alt={`${name} logo`} />
      </div>
