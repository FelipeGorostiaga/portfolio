  ...
  return (
    <Card>
      <Link href={props.companyLink}  target="_blank" rel="noopener noreferrer"
            className="mb-16 flex flex-row bg-gray-100 px-10 py-10 rounded-xl shadow-xl w-full dark:bg-spacegray cursor-pointer">
        ...
        <div className="pl-8 flex flex-col gap-0">
          <h3 className="text-3xl font-sans font-semibold dark:text-neutral-200 mb-1">{props.title}</h3>
          <div className="mb-4">
            <span className="text-base font-light dark:text-[#adadad]">{props.companyName}</span>
            <span className="mx-3 dark:text-[#adadad]">|</span>
            <span className=" text-base font-light dark:text-[#adadad]">{`${startDate} - ${endDate}`}</span>
          </div>
