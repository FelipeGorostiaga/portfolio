  ...
  return (
    <>
      <div className="w-full max-w-5xl mx-auto pt-12 pb-16 flex flex-col md:pt-36 md:pb-24 z-10">
        <div className="flex flex-col-reverse gap-8 items-center justify-between md:flex-row md:gap-14 md:justify-center lg:gap-20">
      ...
      after:content-[close-quote] after:text-2xl sm:after:text-5xl after:font-serif after:text-blue-400 dark:after:text-blue-600">
        ...
        <p className="font-sans text-base mt-12 font-light m-0 text-center break-normal px-6 xs:px-10 sm:px-16 text-neutral-900 dark:text-gray-300 md:text-xl md:px-32">
