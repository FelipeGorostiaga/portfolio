...
const Home = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto pt-12 pb-16 flex flex-col md:pt-36 md:pb-24">
      ...
      before:content-[open-quote] before:text-5xl before:font-serif before:text-blue-400
      after:content-[close-quote] after:text-5xl after:font-serif after:text-blue-400">
        He
