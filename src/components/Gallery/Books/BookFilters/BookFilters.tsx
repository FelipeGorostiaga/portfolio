  ...
  return (
    <div className="w-full flex flex-row items-center justify-between gap-5 my-3 py-4">
      <div
        ...
        gap-2 rounded-2xl sm:w-[400px] border-2 ${inputFocused ? 'border-[#1976D2]' : 'border-neutral-200'}`}>
        <input value={searchValue}
               onChange={e => setSearchValue(e.target.value)}
               className="outline-none bg-transparent font-sans w-full caret-blue-400 text-lg text-neutral-700 group-hover:bg-red-400"
