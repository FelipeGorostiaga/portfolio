...
const Games = () => {
  ...
  return (
    <div className="flex flex-col max-w-5xl gap-8 px-4">
      <Card href="/games/game-of-life"
            className="flex flex-col sm:flex-row gap-6 p-8 bg-gray-100 dark:bg-spacegray rounded-xl hover:scale-[1.005] hover:bg-gray-200">
        <>
          ...
          <div className="flex flex-col gap-5 px-2">
            <h1 className="text-neutral-800 dark:text-neutral-100 text-2xl sm:text-4xl font-bold mt-2">Game of Life</h1>
            <p className="text-sm sm:text-base text-neutral-800 dark:text-neutral-300">A cellular automaton devised by
              the British
      ...
      <Card href="/games/minesweeper"
        ...
        <>
          ...
          <div className="flex flex-col gap-5 px-2">
            ...
            <p className="text-sm sm:text-base text-neutral-800 dark:text-neutral-300">A logic puzzle video game. The
              game features a grid of clickable squares, with hidden mines scattered
      ...
      <Card href="/games/snake"
            className="flex flex-col sm:flex-row gap-6 p-8 bg-gray-100 dark:bg-spacegray rounded-xl hover:scale-[1.005] hover:bg-gray-200">
        <>
          <Image src="/snake.svg" alt="snake" height={imgSize} width={imgSize}
                 className={`object-cover w-[96px] h-[96px] sm:w-[128px] sm:h-[128px] aspect-square self-center sm:self-auto`} />
          <div className="flex flex-col gap-5 px-2">
            <h1 className="text-neutral-800 dark:text-neutral-200 text-2xl sm:text-4xl font-bold mt-2">Snake</h1>
            <p className="text-sm sm:text-base text-neutral-800 dark:text-neutral-300">The all-time classic arcade game. The objective of the game
            is to eat as many apples as possible, without colliding with the surroundings or the growing body of the snake.</p>
          </div>
        </>
      </Card>
    </div>
