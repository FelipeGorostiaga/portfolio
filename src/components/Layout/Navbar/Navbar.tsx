...
const Navbar = () => {
  ...
  return (
    <nav
      className="bg-neutral-100 bg-opacity-70 h-16 px-6 md:pl-12 md:pr-6 flex flex-row items-center border-b-2 border-gray-300 dark:bg-transparent dark:border-gray-600 z-20">
